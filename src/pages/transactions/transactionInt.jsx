...
export default function TransactionInt() {
  ...
  const handleDelete = async () => {
    const deletedBy = accessToken?.userName || accessToken?.username || accessToken?.name || accessToken?.EmployeeName || "system";
    try {
                ...
                {receiptGroups.length === 0 ? (
                  ...
                  <Box key={group.hdr.ID || gi} sx={{ mb: 3 }}>
                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 1,
                      px: 1.5, py: 1, backgroundColor: darkMode ? alpha("#fff", 0.05) : alpha("#1a3a5c", 0.07), borderRadius: 1, mb: 1 }}>
                ...
                {receiptGroups.length > 0 && (
                  <>
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 0.5,
                      backgroundColor: darkMode ? alpha("#fff", 0.04) : alpha("#1a3a5c", 0.05), borderRadius: 2, p: 2 }}>
